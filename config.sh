...
print_modname() {
  ...
  ROOTMGR="Unknown"
  if [ -d /data/adb/magisk ] || getprop persist.magisk.version >/dev/null 2>&1; then
    ROOTMGR="Magisk"
  ...
  ui_print " Android   : ${ANDROID_VER:-unknown}"
  ui_print " Root      : ${ROOTMGR:-unknown}"
  ui_print '─────────────────────────────────────'
  ui_print ' Debloater - Oppo/ColorOS (CN) by X1'
  ui_print ' Compatible: Magisk / KernelSU / APatch'
  ui_print ' Version v0.3.2'
  ui_print ' Github: @ox1d3x3'
  ui_print '─────────────────────────────────────'
  ui_print 'Installing: Debloater - Oppo/ColorOS (CN) by Ox1d3x3 (v0.3.2)'
  ui_print '- Package-state debloater (disable/enable)'
  ui_print '- Android 12–16'
  ui_print '- Lists in /sdcard/debloater'
}
